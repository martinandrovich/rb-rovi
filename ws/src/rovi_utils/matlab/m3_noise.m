close all; clear; clc;
run("rovi_common.m");
A = readmatrix(DIR_DATA + "/M3_test_noise/rovi_pose.csv")
...
export_fig(DIR_IMGS + '/M3/results/' + 'M3_3_scatter.pdf', '-painters')

figure(2)
now = plot_quat_experimenet(A,z_1)
export_fig(DIR_IMGS + '/M3/results/' + 'M3_3_ori.pdf', '-painters')

figure(3)
do_it = scatter_plot_experiment(A, z_2)
export_fig(DIR_IMGS + '/M3/results/' + 'M3_6_scatter.pdf', '-painters')

figure(4)
n0w = plot_quat_experimenet(A, z_2)
export_fig(DIR_IMGS + '/M3/results/' + 'M3_6_ori.pdf', '-painters')

figure(5)
do_it = scatter_plot_experiment(A, z_3)
export_fig(DIR_IMGS + '/M3/results/' + 'M3_9_scatter.pdf', '-painters')

figure(6)
n0w = plot_quat_experimenet(A, z_3)
export_fig(DIR_IMGS + '/M3/results/' + 'M3_9_ori.pdf', '-painters')

figure(7)
do_it = scatter_plot_experiment(A, z_5)
export_fig(DIR_IMGS + '/M3/results/' + 'M3_12_scatter.pdf', '-painters')

figure(8)
now = plot_quat_experimenet(A, z_5)
export_fig(DIR_IMGS + '/M3/results/' + 'M3_12_ori.pdf', '-painters')
